            ...
            <div className="container mx-auto px-6 relative z-10">
              <div className="text-center max-w-4xl mx-auto">
                ...
                <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
                  Store your notes and files with <strong className="text-primary">revolutionary keyless encryption</strong>. 
                  Built with TideCloak - the security that doesn't exist, so it can't be stolen.
                </p>
                
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                  <VaultLogin />
                  <Button variant="outline" size="lg" className="border-primary text-primary hover:bg-primary/10 text-lg px-8 py-6" onClick={handleViewGitHub}>
            ...
            <div className="container mx-auto px-6">
              <div className="text-center max-w-3xl mx-auto mb-16">
                <h2 className="text-4xl font-bold mb-6">
                  What Makes This Vault <span className="text-primary">Unbreakable</span>
                </h2>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                {features.map((feature, index) => (
                  <Card key={index} className="relative overflow-hidden shadow-lg border-0">
                    <CardHeader className="text-center pb-4">
                      <div className={`w-16 h-16 mx-auto mb-4 rounded-2xl ${feature.gradient} flex items-center justify-center`}>
              ...
              <div className="max-w-2xl mx-auto">
                ...
                <div className="space-y-4">
                  {benefits.map((benefit, index) => (
                    <div key={index} className="flex items-start gap-3 p-4 rounded-xl bg-card shadow-lg">
